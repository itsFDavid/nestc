/**
 * Nest-C vs NestJS — Benchmark: Stress Test
 * Description: Incremento progresivo de carga hasta saturar el sistema y encontrar el punto de ruptura.
 * Duration: 2 minutes 30 seconds
 * Peak VUs: 800
 *
 * Usage:
 * Nest-C:  k6 run benchmark_3_stress.js
 * NestJS:  k6 run -e API_URL=http://127.0.0.1:3000 -e METHOD=PATCH benchmark_3_stress.js
 */
