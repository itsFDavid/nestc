    ...
    scenarios: {
        spike: {
            ...
            stages: [
                ...
                { duration: '5s',  target: 500 },  // ¡AVALANCHA REPENTINA de 500 usuarios!
                { duration: '15s', target: 500 },  // Mantener el castigo
                { duration: '10s', target: 0 },    // Bajar la carga y ver si se recupera
            ],
        },
    },
};
