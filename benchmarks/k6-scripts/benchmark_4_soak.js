/**
 * Nest-C vs NestJS — Benchmark: Soak Test
 * Description: Carga fuerte y sostenida para detectar fugas de memoria (memory leaks) y degradación a largo plazo.
 * Duration: 2 hours
 * VUs: 100 constantes
 *
 * Usage:
 * Nest-C:  k6 run benchmark_4_soak.js
 * NestJS:  k6 run -e API_URL=http://127.0.0.1:3000 -e METHOD=PATCH benchmark_4_soak.js
 */
